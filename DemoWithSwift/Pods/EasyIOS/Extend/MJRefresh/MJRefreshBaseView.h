...
@interface MJRefreshBaseView : UIView
{
    ...
    // 子控件
    __strong UILabel *_lastUpdateTimeLabel;
...
// 内部的控件
@property (nonatomic, strong, readonly) UILabel *lastUpdateTimeLabel;
...
// 代理
@property (nonatomic, strong) id<MJRefreshBaseViewDelegate> delegate;
