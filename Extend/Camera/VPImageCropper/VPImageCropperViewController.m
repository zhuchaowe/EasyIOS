...
- (void)initControlBtn {
    UIView *btnView = [[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height - 80.0f, self.view.width, 80)];
    btnView.backgroundColor = [UIColor blackColor];
    btnView.alpha = 0.9;
    [self.view addSubview:btnView];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 80.0f, 100, 80)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - 80.0f, 100, 80.0f)];
    ...
    [confirmBtn.titleLabel setTextAlignment:NSTextAlignmentRight];
    confirmBtn.titleLabel.textColor = [UIColor whiteColor];
